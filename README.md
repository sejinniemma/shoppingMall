...
- loadItems() : I called 'data.json' file using 'fetch'
- using items from 'data.json' I made displayItems() which shows all items and
- make setEventListener() which is filtered when they click button
